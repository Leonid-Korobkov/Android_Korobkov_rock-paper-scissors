...
class MainActivity : AppCompatActivity() {
    ...
    private fun checkResult() {
        ...
        val result = when (userText) {
            ...
            "Бумага" -> if (computerText == "Спок" || computerText == "Камень") "Вы победили!!!  Бумага - подставляет Спока" else "Вы проиграли"
            "Спок" -> if (computerText == "Ножницы" || computerText == "Камень") "Вы победили!!!  Спок - ломает ножницы" else "Вы проиграли"
            "Ящерица" -> if (computerText == "Спок" || computerText == "Бумага") "Вы победили!!!  Ящерица - отравляет Спока" else "Вы проиграли"
            "Камень" -> if (computerText == "Ящерица" || computerText == "Ножницы") "Вы победили!!!  Камень - давит ящерицу" else "Вы проиграли"
            "Ножницы" -> if (computerText == "Ящерица" || computerText == "Бумага") "Вы победили!!!  Ножницы - обезглавливают ящерицу" else "Вы проиграли"
